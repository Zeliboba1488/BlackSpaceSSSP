...
ent-PosterLegitHereForYourSafety = Здесь для вашей безопасности
    ...
    .suffix = { "" }
ent-PosterLegitNanotrasenLogo = Герб Союза
    .desc = Плакат с изображением герба Союза Планет.
    .suffix = { "" }
...
ent-PosterLegitReportCrimes = Сообщайте о преступлениях!
    .desc = Плакат, призывающий оперативно сообщать о преступлениях или подстрекательских действиях в милицию.
    .suffix = { "" }
...
ent-PosterLegitFoamForceAd = Реклама Пенного Патруля
    ...
    .suffix = { "" }
ent-PosterLegitCohibaRobustoAd = Реклама Золотое Руно
    .desc = Золотое Руно, трубочный табак, сделаный по ГОСТ.
    .suffix = { "" }
...
ent-PosterLegitFruitBowl = Миска с фруктами
    ...
    .suffix = { "" }
ent-PosterLegitPDAAd = Реклама ПЭД
    .desc = Плакат, рекламирующий новейшие Персональные Электронные Документы от советских инженеров.
    .suffix = { "" }
ent-PosterLegitEnlist = Служба!
    .desc = Сегодня мужчиной считается тот кто отслужил!
    .suffix = { "" }
...
ent-PosterLegitNoERP = Скажи "нет" сексу!
    .desc = Этот плакат напоминает гражданам, что эротика и порнография запрещены на станциях Союза.
    .suffix = { "" }
...
ent-PosterLegitJustAWeekAway = Всего неделя...
    ...
    .suffix = { "" }
ent-PosterLegitSecWatch = На страже порядка
