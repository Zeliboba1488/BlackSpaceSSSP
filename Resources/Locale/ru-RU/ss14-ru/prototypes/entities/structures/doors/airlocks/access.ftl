...
ent-HighSecArmoryLocked = { ent-HighSecDoor }
    .suffix = Оружейная, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockArmyArmyGlass = { ent-AirlockArmyGlass }
    .suffix = Армия Союза, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockArmyArmyGeneralGlass = { ent-AirlockArmyGeneralGlass }
    .suffix = Генерал, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockArmyArmyLieutenantGlass = { ent-AirlockArmyLieutenantGlass }
    .suffix = Поручик, Закрыт
    .desc = { ent-HighSecDoor.desc }
