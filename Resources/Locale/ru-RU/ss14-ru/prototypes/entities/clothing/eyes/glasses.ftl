...
ent-ClothingEyesGlassesSunglasses = солнцезащитные очки
    .desc = Подходят как для милиции, так и для карго.
    .suffix = { "" }
ent-ClothingEyesGlassesSecurity = солнцезащитные очки милиции
    .desc = Странная древняя технология помогает обеспечить простейшую защиту глаз. Улучшенное покрытие блокирует различные вспышки. 
    .suffix = { "" }
