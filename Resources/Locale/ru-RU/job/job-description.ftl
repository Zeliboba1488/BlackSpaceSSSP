...
job-description-cadet = Изучите основы задержания преступников и порядки организации пункта ОВД.
...
job-description-hop = Справедливо распределяйте доступы с помощью консоль ЭК карт, управляйте сервисным отделом и берегите Иана.
job-description-hos = Управляйте своими сотрудниками и следите за их эффективностью, подавляйте инакомыслие, и обеспечивайте безопасность других глав.
...
job-description-warden = Патрулируйте пункт милиции, следите за тем, чтобы никто не воровал из оружейной, и чтобы все заключенные были оформлены и выпущены по окончании срока.
